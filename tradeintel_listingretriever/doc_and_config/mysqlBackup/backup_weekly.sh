...
# @Author: Tim Grunshaw
#
# This script does a FULL backup everytime, the compresses them and removes old backups (as per AGE below).
...
BACKUPDIR=/home/tim/mysqlBackup/backups/weekly
BACKUPUSER=root
TMPFILE="/tmp/innobackupex-runner.$$.tmp"

# Age of oldest retained backups in days.
AGE=39 # One month plus one week plus one to be sure. 

# Some info output

echo "----------------------------"
echo
echo "backup_weekly.sh: MySQL backup script"
echo "Started: `date`"
echo
